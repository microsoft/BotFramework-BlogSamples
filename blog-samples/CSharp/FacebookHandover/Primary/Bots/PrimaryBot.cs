...
namespace Primary.Bots
{
	...
	public class PrimaryBot : ActivityHandler
	{
		...
		{
			_logger.LogInformation("Processing an Event Activity.");
		...
		{
			_logger.LogInformation("Standby message received.");
		...
		{
			_logger.LogInformation("Thread Control Request message received.");
