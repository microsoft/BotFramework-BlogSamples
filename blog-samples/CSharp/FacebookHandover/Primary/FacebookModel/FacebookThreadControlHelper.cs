...
namespace Primary.FacebookModel
{
    public static class FacebookThreadControlHelper
    {
        ...
        public static async Task<bool> RequestThreadControlToBot(string pageToken, string userId, string message)
		{
        ...
        public static async Task<bool> PassThreadControlToPrimaryBot(string pageToken, string userId, string message)
		{
			var hod = new { recipient = new { id = userId }, metadata = message };
            return await PostAsync("take_thread_control", pageToken, JsonConvert.SerializeObject(hod));
        }

		public static async Task<bool> PassThreadControlToBot(string pageToken, string targetAppId, string userId, string message)
		{
