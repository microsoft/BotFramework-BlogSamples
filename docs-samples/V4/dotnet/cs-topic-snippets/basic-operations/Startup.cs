...
namespace basicOperations
{
    public class Startup
    {
        ...
        {
            services.AddBot<MetaBot>(options =>
            {
            ...
            services.AddSingleton(sp =>
            {
                ...
                {
                    TopicState = state.CreateProperty<TopicState>(StateAccessors.TopicStateName),
                    SelectionDialogState = state.CreateProperty<DialogState>(StateAccessors.SelectionDialog),
                };
            });
        }
