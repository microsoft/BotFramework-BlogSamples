# bot-builder-tutorial-luis Bot

This bot has been created using [Microsoft Bot Framework](https://dev.botframework.com), 

This bot is designed to do the following:

This version of a bot for the hypothetical Contoso Cafe uses LUIS to determine whether the user wants to make a reservation. If the reservation intent is detected by LUIS, the bot invokes the reservation dialog.
