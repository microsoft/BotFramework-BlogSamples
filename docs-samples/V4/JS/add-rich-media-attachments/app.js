 ...
 *    For example: "main": "add-rich-media-attachments/app.js" to run the this sample bot.
 * 3) run the bot in debug mode. 
 * 4) Load the emulator and point it to: http://localhost:3978/api/messages
 * 5) Send the message "hi" to engage with the bot to see all the rich media responses.
 *
 */ 
