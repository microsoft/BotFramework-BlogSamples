/*
 * Botbuilder v4 SDK - QnAMaker bot as Middleware.
 * 
 * This bot demonstrates how to use QnAMaker as middleware to answer user's questions.
 ...
 * You can create a FREE QnAMaker account here: http://qnamaker.ai. Help instructions can be found here:
 ...
 *    For example: "main": "qnamaker/app-middleware.js" to run the this sample bot.
...
server.post('/api/messages', (req, res) => {
    adapter.processActivity(req, res, async (context) => {
        ...
        if (isMessage && !context.responded) {
